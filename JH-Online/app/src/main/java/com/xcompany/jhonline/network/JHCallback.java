...
public abstract class JHCallback<T> extends AbsCallback<T> {
    ...
    public T convertResponse(Response response) throws Exception {
        ...
        if (!TextUtils.isEmpty(jsonString)) {
            ...
            if(object.getString("code") != null && "666".equalsIgnoreCase(object.getString("code"))){
                ...
                throw new IllegalStateException(object.getString("msg") == null ? "服务器返回数据格式异常" : object.getString("msg"));
