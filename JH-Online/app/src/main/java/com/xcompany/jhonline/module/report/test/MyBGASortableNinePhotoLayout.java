...
public class MyBGASortableNinePhotoLayout extends RecyclerView implements BGAOnItemChildClickListener, BGAOnRVItemClickListener {
    private MyBGASortableNinePhotoLayout.PhotoAdapter mPhotoAdapter;
    private ItemTouchHelper mItemTouchHelper;
    private MyBGASortableNinePhotoLayout.Delegate mDelegate;
    ...
    private void afterInitDefaultAndCustomAttrs() {
        ...
        mItemTouchHelper = new ItemTouchHelper(new MyBGASortableNinePhotoLayout.ItemTouchHelperCallback());
        ...
        mPhotoAdapter = new MyBGASortableNinePhotoLayout.PhotoAdapter(this);
    ...
    public void setDelegate(MyBGASortableNinePhotoLayout.Delegate delegate) {
        mDelegate = delegate;
    }
