...
/**
 * Created by xieliang on 2018/11/28 23:16
 */
public class StarBar extends View {
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        this.starDistance = (int) mTypedArray.getDimension(R.styleable.RatingBar_starDistance, 5);
        this.starSize = (int) mTypedArray.getDimension(R.styleable.RatingBar_starSize, 10);
