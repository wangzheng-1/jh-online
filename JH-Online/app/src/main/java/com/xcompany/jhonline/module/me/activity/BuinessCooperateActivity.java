...
public class BuinessCooperateActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buiness_cooperate);
            ...
            switch (msgWhat){
                case 1:
                    ...
                    if(personCenterBean != null && personCenterBean.getImages()!= null
                            && personCenterBean.getImages().size() >=1){
                        String imageUrl = personCenterBean.getImages().get(0);
                        GlideApp.with(BuinessCooperateActivity.this).load(ReleaseConfig.getInstance().getDisplayBaseUrl() +  imageUrl)
