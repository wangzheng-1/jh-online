            ...
            switch (msgWhat){
                case 1:
                    ...
                    if(personCenterBean != null && personCenterBean.getImages()!= null
                            && personCenterBean.getImages().size() >=2){
                        String imageUrl = personCenterBean.getImages().get(1);
                        GlideApp.with(AboutUsActivity.this).load(ReleaseConfig.getInstance().getDisplayBaseUrl() +  imageUrl)
